...
public class Drinks extends Activity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (bundle != null) {
		 ...
		 // get the listview
        expListView = (ExpandableListView) findViewById(R.id.drinkList);
    ...
    private void prepareListData() {
        ...
        // Adding child data
        //List<String> beer = db.getBeerDrinkLabels();
        ...
        other.add("2 Guns");
        other.add("The Smurfs 2");
        other.add("The Spectacular Now");
        other.add("The Canyons");
        other.add("Europa Report");
